...
<html>
  ...
  <head>
    ...
    <title>CREPS de <?php echo IndexForm::getNomEtab(); ?></title>
  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>CREPS</b> DE <b><?php echo IndexForm::getNomEtab(); ?></b></h1>
            </header>
            <!-- START TIMER -->
            ...
            <div class="col-lg-12 col-lg-offset-0 mt centered">
            	<h4><b>Réouverture de la plateforme le 26 décembre</b></h4>
