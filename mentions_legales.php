...
<link rel="stylesheet" type="text/css" href="administrateur/vendor/bootstrap/css/bootstrap.css">
<?php
...
<div class="alert alert-success">
  <strong>M</strong>entions légales
</div>

<p align="justify">
  Responsable de Publication : '.IndexForm::getDirecteur().', directeur(trice)  du '.IndexForm::getNomEtab().'</br>
    
  Conception et réalisation ORIONTRONIC - <a href="http://www.oriontronic.com " > http://www.oriontronic.com</a></br>
    <div class="alert alert-info"> 
  '.IndexForm::getAdresseEtab().' -'.IndexForm::getCPVilleEtab().'
  <p align="justify">
   Courriel : <a href=" mailto:'.IndexForm::getMAilFormation().'?subject=Informations depuis les mentions légales. " >'.IndexForm::getMAilFormation().'</a>
 <p align="justify">  

  
</div>
  
  Hébergement : L’hébergement de <a class="spip_out" href="'.IndexForm::getSiteWeb().'"><span style="text-decoration: underline;"><span style="color: #0066cc;">'.IndexForm::getSiteWeb().'</span></span></a> est assuré par la société '.IndexForm::getStructureHebergement().' - FRANCE
<p align="justify">
<h3>Données personnelles</h3>
<p align="justify">

<h3> 1. Utilisation des données personnelles collectées sur le site : </h3>

    Aucune information personnelle n’est ni collectée à l‘insu des visiteurs ni cédée ou revendue à des tiers ou utilisée à des fins non prévues.
<p align="justify">
Recevoir la lettre d’information du '.IndexForm::getNomEtab().' :

Les seules données obligatoirement collectées dans ce cas sont les nom, prénom et mail.

    Les autres données susceptibles d’être demandées ne sont pas obligatoires et sont collectées selon l‘accord du visiteur.
    Les données recueillies sur le site sont strictement à usage interne.
    Les adresses électroniques pourront être utilisées pour des envois d‘informations (newsletter, évents et éventuellement cas particuliers). 
    Le site du '.IndexForm::getNomEtab().' s’engage à réserver ces adresses à ces seuls usages.

 <p align="justify">

<h3>2. Droit d’accès, de modification et de suppression</h3>

Vous disposez, conformément à l’article 34 de la loi "Informatique et Libertés" du 6 janvier 1978, d’un droit d’accès, de rectification, de modification et de suppression concernant les données qui vous concernent. Vous pouvez demander la radiation de votre adresse électronique du fichier de la lettre d’information du '.IndexForm::getNomEtab().'. </br>
Vous pouvez exercer vos droits en nous contactant par courrier électronique à : '.IndexForm::getMAilFormation().' ou par courrier postal à l’adresse :   '.IndexForm::getAdresseEtab().'</br>

    Ce site emploie-t-il des cookies ? Un cookie de session est utilisé uniquement pour les visiteurs inscrits sur le site privé.

Le principe : Vos logins et mot de passe sont mémorisés par votre navigateur afin que vous puissiez revenir sur la partie privée du site à tout moment sans vous ré-identifier dans l‘espace de login, et ce jusqu‘à ce que vous décidiez de vous désidentifier .

L’accès au site n’est en aucun cas conditionné par votre acceptation de ce cookie. Si votre ordinateur refuse les cookies, vous devrez alors vous ré-identifier à chacune de vos visites.
<p align="justify">
Rappels juridiques : Les documents mis en ligne doivent s’inscrire dans le droit national et international et respecter le Code de la propriété intellectuelle ainsi que les prescriptions de la CNIL.
<p align="justify">
...
3. Protection des mineurs et droit au respect de la vie privée
<p align="justify">
...
Pour toute question ou réaction concernant le site, nous vous invitons à nous contacter par courrier électronique.</div>
